    ...
    <div class="container">
      <div class="row centered">
        <div class="col-xs-4 col-sm-4 col-md-4">
          <a href="https://www.facebook.com/youssef.lazar" alt="Lien Facebook" /><i class="fa fa-facebook"></i></a>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4">
          <a href="https://www.linkedin.com/in/youssef-lazar-5b60b8156/" alt="Lien linkedin"><i class="fa fa-linkedin"></i></a>
        </div>
        <div class="col-xs-4 col-sm-4 col-md-4">
          <a href="https://www.instagram.com/yousseflazr/?hl=fr" alt="Lien Instagram"><i class="fa fa-instagram"></i></a>
        </div>
